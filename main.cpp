...
// First when finding the minimum element, we need to find the leftmost entry, second instead of moving the minimum element to the front,
// we need to move all the elements to the left then add the minimum element
template <typename T>
